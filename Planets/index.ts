...
let massInput: HTMLInputElement;
let xVelInput: HTMLInputElement;
let yVelInput: HTMLInputElement;
let xPosInput: HTMLInputElement;
let yPosInput: HTMLInputElement;
let followInput: HTMLInputElement;
...
function setup() {
    ...
    radiusInput = document.getElementById("radiusInput") as HTMLInputElement;
    massInput = document.getElementById("massInput") as HTMLInputElement;
    xVelInput = document.getElementById("xVel") as HTMLInputElement;
    yVelInput = document.getElementById("yVel") as HTMLInputElement;
    xPosInput = document.getElementById("xPos") as HTMLInputElement;
    yPosInput = document.getElementById("yPos") as HTMLInputElement;
    followInput = document.getElementById("followInput") as HTMLInputElement;
